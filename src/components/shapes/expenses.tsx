...
const Expenses: React.FC<ExpensesProps> = ({ selectedDate, onTotalChange }) => {
  ...
  fetchDespesas();
    ...
    return (
        ...
        {/* Despesas */}
        <div className="bg-[#EBEBEB] w-[255px] h-[340px] sm:w-[360px] sm:h-[420px] md:w-[530px] md:h-[346px] lg:w-[520px] lg:h-[340px] xl:w-[540px] xl:h-[330px] flex flex-col items-start justify-start gap-3 rounded-lg shadow-md p-4 overflow-y-auto hide-scrollbar ">
