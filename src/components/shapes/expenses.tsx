...
interface ExpensesProps {
  ...
  const Expenses: React.FC<ExpensesProps> = () => {
    ...
    return (
        <div className="relative ml-4 mt-4 sm:ml-4 sm:mt-4 md:ml-4 md:mt-4 lg:ml-4 lg:mt-4 xl:ml-4 xl:mt-4">
        ...
        {/* Entradas de receita */}
        <div className=" bg-[#EBEBEB] w-[255px] h-[325px] sm:w-[360px] sm:h-[335px] md:w-[530px] md:h-[346px] lg:w-[520px] xl:w-[530px] flex flex-col items-start justify-start gap-3 rounded-lg shadow-md p-4">
          ...
          <div className="w-2/3 sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 text-xs bg-[#E1E1E1] text-[#000000] p-2 rounded-lg font-poppins">
            ...
            <div className="w-2/3 sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 text-xs bg-[#E1E1E1] text-[#000000] p-2 rounded-lg font-poppins">
                <div className="flex items-center gap-2">
                    ...
                    <span>Curso de mandarim - R$ 398,90</span>
                </div>
