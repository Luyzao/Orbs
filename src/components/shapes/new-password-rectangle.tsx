...
interface NewPasswordRectangleProps {
    className?: string;
}

const NewPasswordRectangle: React.FC<NewPasswordRectangleProps> = () => {
    ...
    const validateForm = () => {
        ...
        const newPasswordValid = newPassword.length >= 8 && noWhiteSpace(newPassword);
        const confirmPasswordValid = confirmPassword.length >= 8 && noWhiteSpace(confirmPassword);
    ...
    return (
        <div className="h-screen flex justify-center items-center bg-cover bg-center" style={{
            ...
            sm:w-[400px] md:w-[460px] lg:w-[560px] h-[610px] sm:h-[600px] md:h-[600px] lg:h-[700px]">
                ...
                mt-7 md:mt-6 lg:mt-7 mx-auto">Nova Senha</h5>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex flex-col relative mb-2">
                        <InputText
                            ...
                            className="w-[220px] h-[32px] bg-[#EDEDED] mt-3 text-[#000000] font-comfortaa text-[10px] rounded-[8px] placeholder-black py-1 px-2 mt-6
                        ...
                        />
                        {newPasswordError && (
                            <small className="p-error text-[10px] mt-0.5 absolute top-[100%] left-0 text-[#FF6961]">Senha inválida!</small>
                        )}
                    </div>
...
export default NewPasswordRectangle;
