...
export default function Home() {
  ...
  return (
    <div className="w-full font-comfortaa pb-0  p-4 flex flex-col gap-4 xl:pt-6 xl:pb-0 xl:p-8">
      <ToolBar />
      <div className="flex flex-col md:flex-row w-auto">
        <div className="w-full flex flex-col gap-4">
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className=" p-4 bg-gray-50 text-black rounded-lg shadow-xl w-7">
              <DoughnutChartDemo />
            </div>
